...
## Simulaciones: Análisis de Sensibilidad

**Objetivo: ** .small[Identificar variaciones en las variables exógenas que pueden ocasionar fuertes desviaciones en las estimaciones de crecimiento económico y desarrollo del sistema financiero, con respecto al escenario base.]

**Pasos: **

.small[
1. Se estima un escenario base. 

2. Tomando en cuenta los quintiles calculados de los datos históricos de cada covariable,  se generó 100 observaciones, manteniendo los valores del escenario base para las demás variables exógenas.

3. Con los datos generados para las covariables, se estiman los valores empleando el modelo VAR.
]
...
kable(estimaciones_2021, booktabs = TRUE,
  ...
  kable_classic("hover", font_size = 16, full_width = F) %>% 
